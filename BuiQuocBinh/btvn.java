...
class Student {
    ...
    private Map<String, Double> grades; // Điểm các môn học của sinh viên có dạng: lthdt: 9.0
    ...
    // Thiết lập điểm cho một môn học
...
class Classroom {
    ...
    // Tổng kết hạng điểm của sinh viên trong lớp
